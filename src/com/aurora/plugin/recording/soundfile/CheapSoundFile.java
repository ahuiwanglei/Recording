...
public class CheapSoundFile {
    ...
    public void WriteFile(File outputFile, int startFrame, int numFrames, ByteArrayOutputStream buff)
    throws java.io.IOException {
}
    
    public ByteArrayOutputStream getFrameStream(int startFrame, int numFrames) throws IOException{return null;}
    public long getFrameSize(){return 0;}
};
