...
package com.aurora.plugin.recording.soundfile;
...
/*
 * (non-Javadoc)
 * @see com.aurora.plugin.recording.soundfile.CheapSoundFile#getNumFrames()
 * ·µ»ØÖ¡×ÜÊý
 */
    ...
    public void WriteFile(File outputFile, int startFrame, int numFrames,
			ByteArrayOutputStream outPutStream) throws java.io.IOException {
	...
	public ByteArrayOutputStream getFrameStream(int startFrame, int numFrames)
			throws IOException {
	...
	case 0:
		...
		int quaEner = ((tmp * 8192) + 0x8000) >> 16;
                ...
                prevEner[0] = quaEner;
                System.out.println("addFrame===>" + gcode0 +"||" + gFac);
