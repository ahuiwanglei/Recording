...
/**
 * CheapWAV represents a standard 16-bit WAV file, splitting it into artificial
 * frames of 20 ms and taking the maximum of each frame to get an approximation
 * of the waveform contour.
 */
			...
			if (chunkHeader[0] == 'f' && chunkHeader[1] == 'm'
				...
				while (i < chunkLen) {
					...
					if (mProgressListener != null) {
						boolean keepGoing = mProgressListener.reportProgress(i
								* 1.0 / chunkLen);
						if (!keepGoing) {
							break;
						}
